package com.uce.edu.hoteles.repository.modelo;
...
public class Hotel {
	...
	@OneToMany(mappedBy = "hotel", cascade = CascadeType.ALL,fetch = FetchType.LAZY) // mappedBy: atributo con que fue mapeado en la otra clase													// (Habitacion)
